...
void createScene(){
	...
	//三角形
	{
		...
		Triangle* triangle = new Triangle(Vec3(-9,-9,-2),Vec3(9,-9,-3),Vec3(10,-5,-70));
	...
	//黄球
	{
		...
		Material mat(Colour(0.0f,0.0f,0.0f),Colour(0.6f,0.6f,0.0f),Colour(0.5f,0.5f,0.6f),100.0f);
			
		RaySphere* geom = new RaySphere(Vec3(2,planedist+6,-35), 3);
	...
	//蓝球
	{
		...
		RaySphere* geom = new RaySphere(Vec3(-7,planedist+8,-30), 3.7);
	...
	//红球
	{
		...
		RaySphere* geom = new RaySphere(Vec3(10,planedist+9.5,-35),4);
